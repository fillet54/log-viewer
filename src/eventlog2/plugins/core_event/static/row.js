...
(function () {
  const html = window.EventLog2?.html;
  if (!html || !window.EventLog2?.registerPluginRowComponent) return;
  ...
  window.EventLog2.registerPluginRowComponent("core-event", CoreEventRow);
})();
